        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/emergencies" className="text-gray-300 hover:text-primary transition-colors">
                  Emergency Care
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">1234 Pet Care Avenue, Vetsville, VS 56789</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">care@vetsync.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <div>
                  <span className="text-gray-300 block">Monday - Friday</span>
              ...
              <li className="mt-2 text-accent font-medium">24/7 Emergency Services Available</li>
            </ul>
          </div>
        </div>

        <div className="mt-8 pt-6 border-t border-gray-700">
          <p className="text-center text-gray-400">© {new Date().getFullYear()} VetSync Animal Hospital. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
